...
pub enum Idempotency {
    /// Reads and naturally idempotent operations (`turn/interrupt`,
...
pub static NATIVE_METHODS: &[MethodSpec] = &[
    ...
    MethodSpec {
        ...
        error_codes: &[codes::INVALID_CWD, codes::CWD_ACCESS_DENIED, codes::IDEMPOTENCY_CONFLICT],
        required_capability: None,
    ...
    MethodSpec {
        ...
        error_codes: &[codes::SESSION_NOT_FOUND, codes::INVALID_CWD, codes::CWD_ACCESS_DENIED],
        required_capability: None,
        idempotency: Idempotency::None,
    },
    MethodSpec {
    ...
    MethodSpec {
        ...
        error_codes: &[codes::SESSION_NOT_FOUND, codes::TURN_ALREADY_ACTIVE, codes::IDEMPOTENCY_CONFLICT, codes::UNSUPPORTED_MODALITY],
        required_capability: None,
        idempotency: Idempotency::Key,
    },
    MethodSpec {
        ...
        error_codes: &[codes::SESSION_NOT_FOUND, codes::TURN_NOT_STEERABLE, codes::IDEMPOTENCY_CONFLICT, codes::UNSUPPORTED_MODALITY],
        required_capability: None,
        idempotency: Idempotency::Key,
    },
    MethodSpec {
        name: "turn/interrupt",
        params_schema: schema_of::<TurnInterruptParams>,
        result_schema: schema_of::<TurnInterruptResult>,
        error_codes: SESSION_ERRORS,
        required_capability: None,
        idempotency: Idempotency::None,
    },
    ...
    MethodSpec {
        ...
        error_codes: &[codes::SESSION_NOT_FOUND, codes::IDEMPOTENCY_CONFLICT, codes::UNSUPPORTED_MODALITY],
        required_capability: None,
        idempotency: Idempotency::Key,
    },
    MethodSpec {
    ...
    MethodSpec {
        ...
        error_codes: &[codes::SESSION_NOT_FOUND, codes::QUEUE_ITEM_NOT_FOUND, codes::TURN_NOT_STEERABLE],
        required_capability: None,
        idempotency: Idempotency::None,
    },
    // ── Catalog / context ──
